...
<head>
  ...
  <title>Masjid Abu Dzar Al-Ghifari Malang</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/user/img/lg-masjid.png" rel="icon">
  <link href="assets/user/img/lg-masjid.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container-md d-flex align-items-center justify-content-between">
      ...
      <div id="logo">
        ...
        <a href="index.html"><img src="assets/user/img/logo-m.png" width="150" height="81" class="d-inline-block align-text-top"/></a>
      </div>
  ...
  <section id="hero">
    ...
    <!-- <div class="row align-items-center min-vh-md-75 mt-7">
      ...
      <!-- <div class="btns">
        <a href="#"><i class="fa fa-apple fa-3x"></i> Sejarah</a>
        <a href="#"><i class="fa fa-play fa-3x"></i> Profil</a>
        <a href="#"><i class="fa fa-windows fa-3x"></i> Visi dan Misi</a>
      </div> -->
    </div>
  ...
  <section id="testimonials" class="padd-section text-center">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-12">
            ...
            <div class="testimonials-content">
              <div id="carousel-example-generic"  data-bs-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  ...
                  <div class="carousel-item  active">
                    <div class="top-top">
                      ...
                      <h2>Profil Masjid Abu Dzar Al-Ghifari</h2>
                      <p>Masjid Abu Dzar Al-Ghifari, merupakan salah satu masjid yang 
                        mencolok dengan serangkaian kesibukannya di bidang dakwah, pendidikan, dan sosial.
                        Sekilas masjid Abu Dzar Al-Ghifari memang tidak terkesan megah. Namun, masjid yan berlokasi di tengah-tengah 
                        pemukiman Griya Shanta, kota Malang ini memiliki segudang kegiatan yang membuatnya menjadi lebih hidup.
                        Masjid Abu Dzar Al-Ghifari, pertama didirikan tahun 1996 oleh warga RW 16 kelurahan Mojolangu, 
                        kecamatan Lowokwaru, kota Malang. Tak hanya sibuk dengan aktivitas shalat berjamaah lima waktu, 
                         ini pun tampak sibuk dengan kegiatan sosial pendidikan. Tak heran, jika masjid ini seringkali dipenuhi 
                         oleh anak-anak muda, yang sebagian besar berstatus sebagai mahasiswa. 
                        Mengingat, lokasi masjid ini pun yang memang tak jauh dari lingkungan kampus.</p>
                      <h4>TAKMIR</h4>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="feature-block">
              ...
              <img src="assets/user/img/svg/cloud.svg" alt="img">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              ...
              <img src="assets/user/img/svg/planet.svg" alt="img">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="feature-block">
              ...
              <img src="assets/user/img/svg/asteroid.svg" alt="img">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-center">
          ...
          <div class="col-md-5 col-lg-3">
            <img src="assets/user/img/about-img.png" alt="About" data-aos="zoom-in" data-aos-delay="100">
          </div>
    ...
    <section id="features" class="padd-section text-center">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          <h2>Program Kegiatan Masjid</h2>
          <p >Adapun Program Kegiatan Masjid Abu Dzar Al-Ghifari Malang adalah sebagai berikut:</p>
        </div>
        ...
        <?php foreach ($kategori as $get): ?>
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="assets/user/img/svg/paint-palette.svg" alt="img">
              <h4 class="title"><a href=""><?= $get['nama_kategori'] ?></a></h4>
              <!-- <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p> -->
            </div>
          </div>
        <?php endforeach ?>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="screens-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="assets/user/img/screen/1.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/user/img/screen/2.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/user/img/screen/3.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/user/img/screen/4.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/user/img/screen/5.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/user/img/screen/6.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/user/img/screen/7.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/user/img/screen/8.jpg" class="img-fluid" alt=""></div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="100">
            <div class="team-block bottom">
              <img src="assets/user/img/team/1.jpg" class="img-responsive" alt="img">
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="200">
            <div class="team-block bottom">
              <img src="assets/user/img/team/2.jpg" class="img-responsive" alt="img">
              <div class="team-content">
                <ul class="list-unstyled">
                  <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                  <li><a href="#"><i class="bi bi-twitter"></i></a></li>
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="300">
            <div class="team-block bottom">
              <img src="assets/user/img/team/3.jpg" class="img-responsive" alt="img">
              <div class="team-content">
                <ul class="list-unstyled">
                  <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                  <li><a href="#"><i class="bi bi-twitter"></i></a></li>
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="400">
            <div class="team-block bottom">
              <img src="assets/user/img/team/4.jpg" class="img-responsive" alt="img">
              <div class="team-content">
                <ul class="list-unstyled">
                  <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                  <li><a href="#"><i class="bi bi-twitter"></i></a></li>
    ...
    <section id="blog" class="padd-sectio">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          ...
          <h2>Kegiatan</h2>
          <p class="separator">Kegiatan Masjid Abu Dzar Al-Ghifari</p>
        </div>
        ...
        <?php foreach ($kegiatan as $get): ?>
          <div class="col-md-6 col-lg-4">
            <div class="block-blog text-left">
              <a href="#"><img src="<?= base_url('assets/upload/') . $get['gambar_kegiatan'] ?>" alt="" class="img-fluid"></a>
              <div class="content-blog">
                <h4><a href="#"><?= $get['nama_kegiatan'] ?> </a></h4>
                <span><?= $get['waktu_kegiatan'] ?></span>
          ...
          <!-- <div class="col-md-6 col-lg-4">
            <div class="block-blog text-left">
              <a href="#"><img src="assets/user/img/blog/blog-image-2.jpg" class="img-responsive" alt="img"></a>
              <div class="content-blog">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="block-blog text-left">
              <a href="#"><img src="assets/user/img/blog/blog-image-3.jpg" class="img-responsive" alt="img"></a>
              <div class="content-blog">
                <h4><a href="#">whats isthe difference between good and bat typography</a></h4>
                <span>05, juin 2017</span>
                <a class="float-end readmore" href="#">read more</a>
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="info">
              <div>
                ...
                <p>Perumahan Griya Shanta, <br>Jl. Candi Jolotundo I Blk. E <br> No.219A, Mojolangu, Lowokwaru,<br> Malang City, East Java 65142</p>
              </div>

              <div>
                <i class="bi bi-phone"></i>
                <p>+62 813 1355 5183</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <p>alghifarimlg@gmail.com</p>
              </div>
