      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Selamat Datang, <span class="text-black fw-bold">Administrator</span></h1>
            <h3 class="welcome-sub-text">Kelola Seluruh Fitur diruang Administrator </h3>
          </li>
        </ul>
        ...
        <li class="nav-item d-none d-lg-block">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="<?= base_url('assets/admin/') ?>images/faces/1admin.png" alt="Profile image"> </a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src="<?= base_url('assets/admin/') ?>images/faces/1admin.png" alt="Profile image">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                ...
                <span class="menu-title">Kas Masjid</span>
                <i class="menu-arrow"></i> 
              </a>
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="<?= base_url('kas_masjid') ?>">Kas Masuk</a></li>
                  <li class="nav-item"> <a class="nav-link" href="<?= base_url('kas_masjid/kaskeluar') ?>">Kas Keluar</a></li>
                  <li class="nav-item"> <a class="nav-link" href="<?= base_url('kas_masjid/rekap') ?>">Rekap</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic1" aria-expanded="false" aria-controls="ui-basic">
                <i class="menu-icon mdi mdi-floor-plan"></i>
                <span class="menu-title">Kas Sosial</span>
                <i class="menu-arrow"></i> 
              </a>
            ...
            <li class="nav-item nav-category">Akses</li>
            <li class="nav-item">
